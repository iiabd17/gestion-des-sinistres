...
const incidentCategories = [
  {
    ...
    types: [
      { value: 'FIBRE_OPTIQUE', label: '0101 · Fibre Optique' },
    ]
  },
  {
    nature: 'Acte de Sabotage',
    types: [
      { value: 'ACTE_DE_SABOTAGE', label: '0201 · Acte de Sabotage' },
    ]
  },
  {
    nature: 'Vol',
    types: [
      { value: 'VOL',    label: '0301 · Vol' },
      { value: 'VOL_PE', label: '0302 · Vol + PE' },
    ]
  },
  {
    nature: 'Incendie',
    types: [
      { value: 'INCENDIE',                 label: '0401 · Incendie' },
      { value: 'INCENDIE_PE',              label: '0402 · Incendie + PE' },
      { value: 'INCENDIE_SURTENSION_ELEC', label: '0403 · Incendie Surtension Électrique' },
    ]
  },
  {
    nature: 'Intempérie',
    types: [
      { value: 'VENT_VIOLENT', label: '0501 · Vent Violent' },
      { value: 'FOUDRE',       label: '0502 · Foudre' },
      { value: 'PLUIE',        label: '0503 · Pluie' },
    ]
  },
  {
    nature: 'Catastrophe Naturelle',
    types: [
      { value: 'TREMBLEMENT_DE_TERRE',  label: '0601 · Tremblement de Terre' },
      { value: 'TEMPETE',               label: '0602 · Tempête' },
      { value: 'INONDATION',            label: '0603 · Inondation' },
      { value: 'GLISSEMENT_DE_TERRAIN', label: '0604 · Glissement de Terrain' },
      { value: 'DEGAT_DES_EAUX',        label: '0605 · Dégât des Eaux' },
    ]
  },
  {
    nature: 'Violence Politique',
    types: [
      { value: 'GREVES_EMEUTES',      label: '0701 · Grèves Émeutes' },
      { value: 'MOUVEMENT_POPULAIRE', label: '0702 · Mouvement Populaire' },
      { value: 'AUTRES',              label: '0703 · Autres' },
    ]
  },
  {
    nature: 'RC',
    types: [
      { value: 'BRIS_DE_MACHINES',            label: '0801 · Bris de Machines' },
      { value: 'BRIS_DE_GLACES',              label: '0802 · Bris de Glaces' },
      { value: 'ACCIDENT_APPAREILS_ELEC',     label: '0803 · Accident aux Appareils Électriques' },
      { value: 'RISQUES_INFORMATIQUES_ELEC',  label: '0804 · Risques Informatiques & Électroniques' },
      { value: 'CHUTE_AERONEF_OBJET_SPATIAL', label: "0805 · Chute d'Aéronef ou Objet Spatial" },
      { value: 'TRANSPORT_INTERNE',           label: '0806 · Transport Interne' },
      { value: 'DOMMAGES',                    label: '0807 · Dommages' },
    ]
  }
]
            ...
            <div className="nd-right">
              ...
              <section className="nd-section-card">
                <div className="nd-section-header">
                  <h2 className="nd-section-title">Localisation (Optionnelle)</h2>
                  <button
                    type="button"
              ...
              {/* Preuves Multimédia */}
              <section className="nd-section-card">
                <h2 className="nd-section-title">Preuves Multimédia (Optionnelle)</h2>
