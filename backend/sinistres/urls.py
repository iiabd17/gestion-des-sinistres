...
urlpatterns = [
    ...
    path('sinistres/<str:pk>/retour-completion/',
         views.SinistreRetourCompletionView.as_view(),
         name='sinistre-retour-completion'),
    ...
    path('equipements/suggestions/',
         views.EquipementSuggestionsView.as_view(),
         name='equipement-suggestions'),
